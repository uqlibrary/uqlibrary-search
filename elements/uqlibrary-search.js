(function () {
  Polymer({
    ...
    ready: function() {
      ...
      var primoPrefix = '&tab=61uq_all&search_scope=61UQ_All&sortby=rank&vid=61UQ&offset=0';
      this.sources = [
        { name: 'Library',
          type: 'all',
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: primoPrefix + '&facet=rtype,exclude,newspaper_articles,lk&facet=rtype,exclude,reviews,lk',
          autoSuggest: true,
        ...
        { name: 'Books',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: primoPrefix + '&facet=rtype,include,books',
          autoSuggest: true,
        ...
        { name: 'Journal articles',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: primoPrefix + '&facet=rtype,include,articles',
          autoSuggest: true,
          api: this.properties.api.value.primoApiAll,
          icon: 'social:school',
        ...
        { name: 'Video & audio',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: primoPrefix + '&facet=rtype,include,videos&facet=rtype,include,audios',
          autoSuggest: true,
          api: this.properties.api.value.primoApiAll,
          icon: 'icons:theaters',
        ...
        { name: 'Journals',
          ...
          urlAppend: ',AND' + primoPrefix + '&mfacet=rtype,include,newspapers,1&mfacet=rtype,include,journals,1&mode=advanced',
          autoSuggest: true,
          api: this.properties.api.value.primoApiLocal,
        ...
        { name: 'Physical items',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: primoPrefix + '&facet=tlevel,include,physical_items',
          autoSuggest: true,
          api: this.properties.api.value.primoApiLocal,
          icon: 'icons:inbox',
          inputPlaceholder: 'Enter a keyword, title, author, etc',
