    ...
    ready: function() {
      ...
      this.sources = [
        ...
        { name: 'Books',
          type: 'books',
          url: this.links.primo,
          urlAppend: '&fn=search&fctN=facet_rtype&fctV=books&ct=facet&vid=61UQ',
          autoSuggest: true,
        ...
        { name: 'Journals',
          type: 'journals',
          url: this.links.primo,
          urlAppend: '&fn=search&fctN=facet_rtype&fctV=journals&vl(1UIStartWith0)=begins_with&ct=search&srt=title&vl(D75285834UI0)=title&vid=61UQ',
          autoSuggest: true,
          api: this.api.primoApiLocal,
