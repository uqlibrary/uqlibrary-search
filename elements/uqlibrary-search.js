  ...
  Polymer({
    ...
    ready: function() {
      ...
      this.$.accountApi.addEventListener('uqlibrary-api-account-loaded', function(response) {
        self.isLoggedIn = (response.detail.hasSession) ? response.detail.hasSession : false;
      });
      ...
      this.sources = [
        { name: 'Library',
          ...
          urlAppend: '&tab=61uq_all&search_scope=61UQ_All&sortby=rank&vid=61UQ&offset=0&facet=rtype,exclude,newspaper_articles&facet=rtype,exclude,reviews',
          autoSuggest: true,
