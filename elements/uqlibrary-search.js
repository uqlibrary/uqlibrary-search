    ...
    ready: function() {
      ...
      this.sources = [
        ...
        { name: 'Books',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: '&tab=61uq_all&search_scope=61UQ_All&sortby=rank&vid=61UQ&offset=0&facet=rtype,include,books,lk',
          autoSuggest: true,
        ...
        { name: 'Journal articles',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: '&tab=61uq_all&search_scope=61UQ_All&vid=61UQ&offset=0&fctV=articles&facet=rtype,include,articles,lk',
          autoSuggest: true,
          api: this.properties.api.value.primoApiAll,
          icon: 'social:school',
        ...
        { name: 'Video & audio',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: '&tab=61uq_all&search_scope=61UQ_All&sortby=rank&vid=61UQ&offset=0&facet=rtype,include,media,lk',
          autoSuggest: true,
          api: this.properties.api.value.primoApiAll,
          icon: 'icons:theaters',
        ...
        { name: 'Journals',
          ...
          urlAppend: ',AND&tab=61uq_all&vid=61UQ&search_scope=61UQ_All&sortby=rank&mfacet=rtype,include,journals,1,lk&mode=advanced&offset=0',
          autoSuggest: true,
          api: this.properties.api.value.primoApiLocal,
        ...
        { name: 'Physical items',
          ...
          url: this.links.primo,
          urlPrepend: 'any,contains,',
          urlAppend: '&tab=61uq_all&search_scope=61UQ_All&vid=61UQ&offset=0&facet=tlevel,include,physical_items,lk',
          autoSuggest: true,
          api: this.properties.api.value.primoApiLocal,
          icon: 'icons:inbox',
          inputPlaceholder: 'Enter a keyword, title, author, etc',
